...
from pytest_splunk_env.splunk.helmut.exceptions import UnsupportedConnectorError
from pytest_splunk_env.splunk.helmut.exceptions.command_execution import (
    CommandExecutionFailure,
)
from pytest_splunk_env.splunk.helmut.log import Logging
from pytest_splunk_env.splunk.helmut.util.rip import RESTInPeace
...
class Splunk(with_metaclass(ABCMeta, Logging)):
    ...
    def inputs(self, contype=None, username=None):
        ...
        @rtype: L{Inputs}
        """
        from pytest_splunk_env.splunk.helmut.manager.inputs import Inputs
    ...
    def saved_searches(self, contype=None, username=None):
        ...
        @rtype: L{SavedSearch}
        """
        from pytest_splunk_env.splunk.helmut.manager.saved_searches import SavedSearches
    ...
    def users(self, contype=None, username=None):
        ...
        @rtype: L{Users}
        """
        from pytest_splunk_env.splunk.helmut.manager.users import Users
